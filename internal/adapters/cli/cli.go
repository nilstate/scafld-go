...
import (
	...
	"github.com/nilstate/scafld-go/internal/app/approve"
	"github.com/nilstate/scafld-go/internal/app/bootstrap"
	"github.com/nilstate/scafld-go/internal/app/build"
	execusecase "github.com/nilstate/scafld-go/internal/app/execspec"
	"github.com/nilstate/scafld-go/internal/app/handoff"
	listusecase "github.com/nilstate/scafld-go/internal/app/list"
	"github.com/nilstate/scafld-go/internal/app/plan"
	"github.com/nilstate/scafld-go/internal/app/report"
	"github.com/nilstate/scafld-go/internal/app/review"
	"github.com/nilstate/scafld-go/internal/app/status"
	"github.com/nilstate/scafld-go/internal/app/validate"
)
...
func runReview(ctx context.Context, args []string, stdout io.Writer, stderr io.Writer) int {
	...
	out, err := review.Run(ctx, store, sessions, clock.System{}, opts.Positionals[0])
	if err != nil {
